const db = 'passwords'
const database = db.getSiblingDB('passwords')
function commands(){
    x = objectId();
    database.thePasswordsCollection.insert({
        "user11": {
            "user": {
                "name": {
                    "first": "Isaiah",
